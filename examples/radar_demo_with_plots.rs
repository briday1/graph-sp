...
fn plot_lfm_pulse(inputs: &HashMap<String, GraphData>, _params: &HashMap<String, GraphData>) -> HashMap<String, GraphData> {
    ...
    println!("PlotLFM: Would generate plot of {} sample LFM pulse", pulse.len());
...
#[cfg(feature = "radar_examples")]
fn plot_range_doppler(inputs: &HashMap<String, GraphData>, _params: &HashMap<String, GraphData>) -> HashMap<String, GraphData> {
