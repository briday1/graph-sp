#!/usr/bin/env python3
"""
Radar processing demo using dagex Python bindings with GraphData
...
dagex can handle complex signal processing workflows.
"""
...
def main():
    separator = "=" * 70
    print(separator)
    print("Python Radar Processing Demo with dagex")
    print(separator)
    print()
